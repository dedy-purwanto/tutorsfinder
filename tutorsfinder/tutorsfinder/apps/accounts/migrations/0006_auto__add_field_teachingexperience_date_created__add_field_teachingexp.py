...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeachingExperience.date_created'
        db.add_column('accounts_teachingexperience', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 12, 8, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'TeachingExperience.date_modified'
        db.add_column('accounts_teachingexperience', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 12, 8, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'TeachingSubject.date_created'
        db.add_column('accounts_teachingsubject', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 12, 8, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'TeachingSubject.date_modified'
        db.add_column('accounts_teachingsubject', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 12, 8, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'EducationBackground.date_created'
        db.add_column('accounts_educationbackground', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 12, 8, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'EducationBackground.date_modified'
        db.add_column('accounts_educationbackground', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 12, 8, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'TeachingLevel.date_created'
        db.add_column('accounts_teachinglevel', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 12, 8, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'TeachingLevel.date_modified'
        db.add_column('accounts_teachinglevel', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 12, 8, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PersonalInformation.date_created'
        db.add_column('accounts_personalinformation', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 12, 8, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PersonalInformation.date_modified'
        db.add_column('accounts_personalinformation', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 12, 8, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeachingExperience.date_created'
        db.delete_column('accounts_teachingexperience', 'date_created')

        # Deleting field 'TeachingExperience.date_modified'
        db.delete_column('accounts_teachingexperience', 'date_modified')

        # Deleting field 'TeachingSubject.date_created'
        db.delete_column('accounts_teachingsubject', 'date_created')

        # Deleting field 'TeachingSubject.date_modified'
        db.delete_column('accounts_teachingsubject', 'date_modified')

        # Deleting field 'EducationBackground.date_created'
        db.delete_column('accounts_educationbackground', 'date_created')

        # Deleting field 'EducationBackground.date_modified'
        db.delete_column('accounts_educationbackground', 'date_modified')

        # Deleting field 'TeachingLevel.date_created'
        db.delete_column('accounts_teachinglevel', 'date_created')

        # Deleting field 'TeachingLevel.date_modified'
        db.delete_column('accounts_teachinglevel', 'date_modified')

        # Deleting field 'PersonalInformation.date_created'
        db.delete_column('accounts_personalinformation', 'date_created')

        # Deleting field 'PersonalInformation.date_modified'
        db.delete_column('accounts_personalinformation', 'date_modified')

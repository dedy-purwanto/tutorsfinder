...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TeachingExperience'
        db.create_table('accounts_teachingexperience', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='teaching_experiences', to=orm['auth.User'])),
            ('school', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('from_year', self.gf('django.db.models.fields.CharField')(max_length=4)),
            ('to_year', self.gf('django.db.models.fields.CharField')(max_length=4)),
        ))
        db.send_create_signal('accounts', ['TeachingExperience'])


    def backwards(self, orm):
        # Deleting model 'TeachingExperience'
        db.delete_table('accounts_teachingexperience')

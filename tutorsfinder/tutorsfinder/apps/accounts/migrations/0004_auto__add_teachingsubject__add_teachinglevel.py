...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TeachingSubject'
        db.create_table('accounts_teachingsubject', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='teaching_subjects', to=orm['auth.User'])),
            ('subject', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['references.Subject'])),
        ))
        db.send_create_signal('accounts', ['TeachingSubject'])

        # Adding model 'TeachingLevel'
        db.create_table('accounts_teachinglevel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='teaching_levels', to=orm['auth.User'])),
            ('level', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['references.Level'])),
        ))
        db.send_create_signal('accounts', ['TeachingLevel'])


    def backwards(self, orm):
        # Deleting model 'TeachingSubject'
        db.delete_table('accounts_teachingsubject')

        # Deleting model 'TeachingLevel'
        db.delete_table('accounts_teachinglevel')

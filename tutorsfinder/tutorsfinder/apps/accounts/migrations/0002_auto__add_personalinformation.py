...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PersonalInformation'
        db.create_table('accounts_personalinformation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='details', unique=True, to=orm['auth.User'])),
            ...
            ('area', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['references.Area'])),
            ('street', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('post_code', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('hourly_rate', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('picture', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
        ))
        db.send_create_signal('accounts', ['PersonalInformation'])


    def backwards(self, orm):
        # Deleting model 'PersonalInformation'
        db.delete_table('accounts_personalinformation')

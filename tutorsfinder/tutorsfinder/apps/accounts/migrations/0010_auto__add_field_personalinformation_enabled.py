...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonalInformation.enabled'
        db.add_column('accounts_personalinformation', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonalInformation.enabled'
        db.delete_column('accounts_personalinformation', 'enabled')

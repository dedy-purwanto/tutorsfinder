...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeachingExperience.subject'
        db.add_column('accounts_teachingexperience', 'subject',
                      self.gf('django.db.models.fields.CharField')(default='-', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeachingExperience.subject'
        db.delete_column('accounts_teachingexperience', 'subject')
